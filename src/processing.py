def get_formatted_list(any_list: list[dict, dict], status: str = None) -> list[dict]:
...
def get_formatted_list_by_date(any_list: list[dict, dict], sort_up: bool = True) -> list[dict]:
